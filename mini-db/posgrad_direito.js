const posgrad_Direito = [
    ...
    },
    {
        ...
        modules: {
            mod1: {
                titleMod: 'MODULO 1 - Direito Administrativo: contextualização',
                contents: [
            ...
            mod3: {
                titleMod: 'MODULO 3 - Licitações e Contratos Administrativos',
                contents: [
    ...
    },
    {
        ...
        modules: {
            ...
            mod3: {
                titleMod: 'MODULO 3 - A Constituição e a proteção dos Direitos',
                contents: [
                    'Estado e Economia',
    ...
    },
    {
        ...
        modules: {
            ...
            mod4: {
                titleMod: 'MODULO 4 - Tópicos Especiais em Direito Tributário',
                contents: [
    ...
    },
    {
        ...
        modules: {
            ...
            mod2: {
                titleMod: 'MODULO 2 - Regulamentação do contrato de trabalho',
                contents: [

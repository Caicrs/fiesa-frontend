...
export default function ChooseCategory() {
    ...
    const posgrad = [
        {
            id: 1,
            title: 'Pós-graduação em Administração pública',
            objectives:
                'Especializar profissionais para capacitá-los a conhecer, analisar e planejar a administração pública em contextos políticos, sociais e econômicos diversos, com base em uma sólida formação sistêmica e organizacional dos processos que envolvem a ação de administrar o público.',
            targetPeoples:
            ...
            modules: {
                ...
                mod2: {
                    ...
                    contents: [
                        'Introdução as Contratações Públicas',
                        'Processos Licitatórios I',
        ...
        {
            id: 2,
            title: 'Pós-graduação em Administração de Recursos Humanos no Setor Público',
            objectives:
                'Preparar profissionais para atuar na administração pública, com o embasamento teórico e prático referente aos recursos humanos, seus processos e aspectos fundamentais na condução de grupos e liderança.',
            targetPeoples:
            ...
            modules: {
                mod1: {
                    ...
                    contents: [
                        'Aspectos Introdutórios em Gestão de Pessoas',
                ...
                mod3: {
                    ...
                    contents: [
                        ...
                        'Organizações Contemporâneas: clima, cultura e desempenho',
        ...
        {
            id: 3,
            title: 'Pós-graduação em Formação de Gestores de Contratos e Licitações',
            objectives:
                'Especializar profissional apto a atuar direta ou indiretamente na área administrativa, permitindo ao aluno, simultaneamente, um enfoque conceitual e empírico nessa seara fundamental para a área pública ou privada.',
            targetPeoples:
        ...
        {
            id: 4,
            title: 'Pós-graduação em Matemática financeira e estatística',
            objectives:
                'Capacitar o gestor tático a exercer a tomada de decisão organizacional em relação às operações financeiras e de análise estatística para que possa identificar os processos operacionais financeiros e desenvolver atividades de coleta, tratamento e análise de dados estatísticos para a sustentabilidade econômico-financeira e o cumprimento do planejamento estratégico da empresa.',
            targetPeoples:
            ...
            modules: {
                ...
                mod2: {
                    ...
                    contents: [
                        ...
                        'Sistemas de Cálculos Financeiros',
                ...
                mod4: {
                    ...
                    contents: [
                        ...
                        'Inferência para a Tomada de Decisão',
        ...
        {
            id: 5,
            title: 'Pós-graduação em Contabilidade Pública',
            objectives:
            ...
            modules: {
                ...
                mod3: {
                    ...
                    contents: [
                        ...
                        'Controle e Extinção de Contratos Públicos',
                ...
                mod4: {
                    ...
                    contents: [
                        ...
                        'Controle e Controladoria Governamental',

...
const Details_main = ({ myId }) => {
    const posgrad = [
            ...
            modules: [
                ...
                },
                {
                    ...
                    contents: [
                        ...
                        'Avaliação na educação de myId a 10 anos',
        ...
        {
            id: 3,
            title: 'Pós-graduação em gestão escolar',
            objectives:
            ...
            modules: [
                ...
                {
                    titleMod:
                        'MODULO 2 - Gestão de Pessoas e Processos Escolares',
                    contents: [
                        'Gestão Escolar',
        ...
        {
            id: 4,
            title: 'Pós-graduação em tecnologias e educação a distância',
            objectives:
        ...
        {
            id: 5,
            title: 'Pós-graduação em Docência no ensino superior',
            objectives:
        ...
        {
            id: 6,
            title: 'Pós-graduação em Metodologias Ativas e Prática Docente',
            objectives:
        ...
        {
            id: 7,
            title: 'Pós-graduação em pedagogia empresarial e educação corporativa',
            objectives:
        ...
        {
            id: 8,
            title: 'Pós-graduação em Tutoria em educação a distância',
            objectives:
        ...
        {
            id: 9,
            title: 'Pós-graduação em Alfabetização e letramento e psicopedagogia institucional',
            objectives:
        ...
        {
            id: 11,
            title: 'Pós-graduação em Metodologia do ensino de Língua Inglesa',
            objectives:
            ...
            modules: [
                ...
                {
                    titleMod:
                        'MODULO 2 - Noções fundamentais da Língua Inglesa',
                    contents: [
                ...
                {
                    titleMod:
                        'MODULO 3 - Metodologia do ensino de língua inglesa',
                    contents: [
        ...
        {
            id: 12,
            title: 'Pós-graduação em Pedagogia Social e Gestão de Projetos Sociais',
            objectives:
            ...
            modules: [
                ...
                {
                    titleMod:
                        'MODULO 2 - Atuação do pedagogo em espaços sociais',
                    contents: [
        ...
        {
            id: 14,
            title: 'Pós-graduação em ciências da educação',
            objectives:
        ...
        {
            id: 15,
            title: 'Pós-graduação em literatura infantil',
            objectives:

const posgrad_Tecnologia = [
    ...
    {
        id: 2,
        title: 'Pós-graduação em Engenharia de Redes de Computadores',
        objectives:
    ...
    {
        id: 3,
        title: 'Pós-graduação em Gestão de Custos e Formação de Preços',
        objectives:
    ...
    {
        id: 4,
        title: 'Pós-graduação em Administração hospitalar',
        objectives:
    ...
    {
        id: 5,
        title: 'Pós-graduação em gestão financeira e orçamentária em organizações públicas',
        objectives:
    ...
    {
        id: 6,
        title: 'Pós-graduação em Sustentabilidade Empresarial',
        objectives:
    ...
    {
        id: 8,
        title: 'Pós-graduação em Auditoria, Compliance e Gestão de Riscos',
        objectives:
    ...
    {
        id: 9,
        title: 'Pós-graduação em engenharia de software com métodos ágeis',
        objectives:

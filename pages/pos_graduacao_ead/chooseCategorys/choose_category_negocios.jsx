...
export default function ChooseCategory() {
    const posgrad = [
        ...
        {
            id: 2,
            title: 'Administração de Recursos Humanos no Setor Público',
            objectives:
        ...
        {
            id: 3,
            title: 'Formação de Gestores de Contratos e Licitações',
            objectives:
        ...
        {
            id: 4,
            title: 'Matemática financeira e estatística',
            objectives:
        ...
        <div className="choose_container">
            <div className="choose_courses">
                ...
                <div className="courses_grid">
                    {posgrad.map((item, i) => (
                        <Link href={`negocios/details/${i}`} key={i}>
